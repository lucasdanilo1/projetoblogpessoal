...
#### Não é necessário nenhuma configuração adicional - apenas se quiser rodar fora do container docker - se for o caso, altere o datasource.url para localhost ao invés de blogpessoal-db (nome do container) no properties do spring.
